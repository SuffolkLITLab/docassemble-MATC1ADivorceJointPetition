...
setup(name='docassemble.MATC1ADivorceJointPetition',
      ...
      install_requires=[
          ...
          'docassemble.MATCSeparationAgreement @ git+https://github.com/SuffolkLITLab/docassemble-MATCSeparationAgreement.git@main',
          'docassemble.MATCFinancialStatement @ git+https://github.com/SuffolkLITLab/docassemble-MATCFinancialStatement.git@main',
          'docassemble.MATCCSGWorksheet @ git+https://github.com/SuffolkLITLab/docassemble-MATCCSGWorksheet.git@main',
          'docassemble.MATCChildCareOrCustodyDisclosureAffidavit @ git+https://github.com/SuffolkLITLab/docassemble-MATCChildCareOrCustodyDisclosureAffidavit.git@main',
          'docassemble.matcfindingsanddeterminations @ git+https://github.com/SuffolkLITLab/docassemble-MATCFindingsAndDeterminations.git@main',
          'docassemble.MATCMotionToAmend @ git+https://github.com/SuffolkLITLab/docassemble-MATCMotionToAmend.git@main',
      ],
      zip_safe=False,
